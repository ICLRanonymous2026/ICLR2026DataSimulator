...
acquisition_time = 2048 * 64 / F_E
generate_and_store_spectrum_multi(scenarios=scenarios, base_path='/data/RAWSIM/RMA/Thesis_work/iclr_simulator/fsk_codes_dataset', split_train_test=True, acquisition_time=acquisition_time, stft_cfgs=stft_cfgs)